...
**Note:** (Latest Python has compatibility issues)
...
either, double click on setup.bat or, Open PowerShell
...
**Developer:** Shin (Tkinter version)
...
- ** وب‌سایت:https://sh1n.org
- ** تلگرام:https://t.me/itsthealephyouknowfromtwitter

### حمایت از توسعه‌دهنده

- ** حمایت مالی (کریپتو):https://nowpayments.io/donation/shin
- ** حمایت مالی (کارت اعتباری):https://buymeacoffee.com/hey_itsmyturn
