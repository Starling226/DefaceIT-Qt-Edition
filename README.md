...
Run the setup script:Bashchmod +x setup.sh
./setup.sh
Run the application:Bashpython3 defaceit_gui_qt.py
...
Navigate to the DefaceIT directory:cmdcd DefaceIT
Run the setup script:cmdsetup.bat
Run the application:cmdpython run.py
...
Note: Translation was generated by Grok
...
۲. به پوشه DefaceIT بروید:cmdcd DefaceIT
